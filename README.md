# rkos - A Linux Distribution of Rust

## Contribution

The `rkos` project relies on community contributions and aims to simplify getting started. To develop `rkos`, clone the repository, then install all dependencies, run the test suite and try it out locally. Pick an issue, make changes, and submit a pull request for community review.
...
3. Contribute code: If you want to develop and contribute code, follow these steps:
   ...
   - Respond to any feedback on your pull request. The `rkos` maintainers will review your changes and may request modifications before merging. Please ensure your code is properly formatted and follows the same style as the existing codebase.
